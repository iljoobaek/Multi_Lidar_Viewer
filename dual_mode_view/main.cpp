...
// capture.isDualMode() -> will return a boolean 
// by default send both packet data in sequence
...
int main( int argc, char* argv[] )
{
    ...
    const std::string filename = "../../../../../data/lidar_dual_mode_snow_1.pcap";
    // const std::string filename = "../../../../../data/lidar_strongest_mode_1.pcap";
    ...
    while( capture.isRun() && !viewer.wasStopped() ){
        ...
        std::cout << capture.isDualMode() << std::endl;
